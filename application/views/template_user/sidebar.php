...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SistemPakarIkan</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
					<li class="active"><a href="<?= base_url(); ?>Home/listikan" class="nav-link">
              ...
              <p>
                ...
                <i class="fas fa-angle-left right"></i>
					...
					<li class="nav-item">
					<li class="nav-link"><a href="<?= base_url(); ?>Auth/user"><em class="fa fa-power-off">&nbsp;</em> Login</a></li>
					</li>
